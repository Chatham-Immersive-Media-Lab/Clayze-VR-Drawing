...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_VrDrawing p_VrDrawing;
        ...
        public static SteamVR_Input_ActionSet_VrDrawing VrDrawing
        {
            get
            {
                return SteamVR_Actions.p_VrDrawing.GetCopy<SteamVR_Input_ActionSet_VrDrawing>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_VrDrawing = ((SteamVR_Input_ActionSet_VrDrawing)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_VrDrawing>("/actions/VrDrawing")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.VrDrawing};
        }
    }
}
